...
/* Generated from ../O.Common/PS.dbd */
...
epicsShareExtern typed_rset *pvar_rset_DigitalDCPSaoRSET,
    *pvar_rset_DigitalScanPSRSET, *pvar_rset_InforminRSET,
    *pvar_rset_aSubRSET, *pvar_rset_aaiRSET, *pvar_rset_aaoRSET,
    ...
    *pvar_rset_permissiveRSET, *pvar_rset_printfRSET, *pvar_rset_psRSET,
    *pvar_rset_selRSET, *pvar_rset_seqRSET, *pvar_rset_stateRSET,
    *pvar_rset_stringinRSET, *pvar_rset_stringoutRSET, *pvar_rset_subRSET,
    *pvar_rset_subArrayRSET, *pvar_rset_waveformRSET;

typedef int (*rso_func)(dbRecordType *pdbRecordType);
epicsShareExtern rso_func pvar_func_DigitalDCPSaoRecordSizeOffset,
    pvar_func_DigitalScanPSRecordSizeOffset,
    pvar_func_InforminRecordSizeOffset, pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_printfRecordSizeOffset, pvar_func_psRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    "DigitalDCPSao", "DigitalScanPS", "Informin", "aSub", "aai", "aao",
    "ai", "ao", "bi", "bo", "calc", "calcout", "compress", "dfanout",
    "event", "fanout", "histogram", "int64in", "int64out", "longin",
    "longout", "lsi", "lso", "mbbi", "mbbiDirect", "mbbo", "mbboDirect",
    "permissive", "printf", "ps", "sel", "seq", "state", "stringin",
    "stringout", "sub", "subArray", "waveform"
};

static const recordTypeLocation rtl[] = {
    {(struct typed_rset *)pvar_rset_DigitalDCPSaoRSET, pvar_func_DigitalDCPSaoRecordSizeOffset},
    {(struct typed_rset *)pvar_rset_DigitalScanPSRSET, pvar_func_DigitalScanPSRecordSizeOffset},
    {(struct typed_rset *)pvar_rset_InforminRSET, pvar_func_InforminRecordSizeOffset},
    ...
    {(struct typed_rset *)pvar_rset_psRSET, pvar_func_psRecordSizeOffset},
...
epicsShareExtern dset *pvar_dset_devDigitalPSRampInt,
    *pvar_dset_devDigitalPSInt, *pvar_dset_devDigitalDCPSInt,
    *pvar_dset_devAPMDigitalPS, *pvar_dset_devHarmonicPSSoft,
    *pvar_dset_devDigitalDCPSNew, *pvar_dset_devDigitalScanPSInt,
    *pvar_dset_devDigitalPSRampInform, *pvar_dset_devAaiSoft,
    *pvar_dset_devAaoSoft, *pvar_dset_devAiSoft, *pvar_dset_devAiSoftRaw,
    ...
    *pvar_dset_devLoPDBUTag, *pvar_dset_devLoSoft,
    *pvar_dset_devLoSoftCallback, *pvar_dset_devLsiSoft,
    *pvar_dset_devLsiEnviron, *pvar_dset_devPSVersion,
    ...
    *pvar_dset_devPsSoft, *pvar_dset_devSiSoft,
    ...
    *pvar_dset_devDPRAMwv, *pvar_dset_devWfPDBDemo,
    *pvar_dset_devWfPDBDemoRepeat;

static const char * const deviceSupportNames[] = {
    "devDigitalPSRampInt", "devDigitalPSInt", "devDigitalDCPSInt",
    "devAPMDigitalPS", "devHarmonicPSSoft", "devDigitalDCPSNew",
    "devDigitalScanPSInt", "devDigitalPSRampInform", "devAaiSoft",
    "devAaoSoft", "devAiSoft", "devAiSoftRaw", "devAiSoftCallback",
    "devTimestampAI", "devAiGeneralTime", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devBoSoft", "devBoSoftRaw", "devBoSoftCallback",
    "devBoGeneralTime", "devBoDbState", "devCalcoutSoft",
    "devCalcoutSoftCallback", "devEventSoft", "devHistogramSoft",
    "devI64inSoft", "devI64inSoftCallback", "devI64outSoft",
    "devI64outSoftCallback", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "devLoPDBUTag", "devLoSoft", "devLoSoftCallback",
    "devLsiSoft", "devLsiEnviron", "devPSVersion", "devLsoSoft",
    ...
    "devPrintfStdio", "devPsSoft", "devSiSoft", "devSiSoftCallback",
    "devTimestampSI", "devSiGeneralTime", "devSiEnviron", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "devSASoft", "devWfSoft",
    "devDPRAMwv", "devWfPDBDemo", "devWfPDBDemoRepeat"
};

static const dset * const devsl[] = {
    pvar_dset_devDigitalPSRampInt, pvar_dset_devDigitalPSInt,
    pvar_dset_devDigitalDCPSInt, pvar_dset_devAPMDigitalPS,
    pvar_dset_devHarmonicPSSoft, pvar_dset_devDigitalDCPSNew,
    pvar_dset_devDigitalScanPSInt, pvar_dset_devDigitalPSRampInform,
    ...
    pvar_dset_devLoPDBUTag, pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback, pvar_dset_devLsiSoft,
    pvar_dset_devLsiEnviron, pvar_dset_devPSVersion, pvar_dset_devLsoSoft,
    ...
    pvar_dset_devPrintfStdio, pvar_dset_devPsSoft, pvar_dset_devSiSoft,
    pvar_dset_devSiSoftCallback, pvar_dset_devTimestampSI,
    pvar_dset_devSiGeneralTime, pvar_dset_devSiEnviron,
    pvar_dset_devSoSoft, pvar_dset_devSoSoftCallback,
    pvar_dset_devSoStdio, pvar_dset_devSASoft, pvar_dset_devWfSoft,
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    pvar_func_arrInitialize, pvar_func_asSub, pvar_func_dbndInitialize,
    pvar_func_decInitialize, pvar_func_helloRegister,
...
int PS_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/CSR_PS";
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: PS_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(PS_registerRecordDeviceDriver(*iocshPpdbbase));
}
